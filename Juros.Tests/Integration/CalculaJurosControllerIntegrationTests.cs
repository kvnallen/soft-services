...
namespace Juros.Tests.Integration
{
    public class CalculaJurosControllerIntegrationTests
    {
        ...
        [InlineData(100, 5, 0.01d, 105.10d)]
        public async void Calcular_DeveRetornarValorCalculado(double valorInicial, int meses, double taxaJuros, double valorEsperado)
        {
            //Arrange
            ...
            var valor = await result.Content.ReadAsJsonAsync<double>();
